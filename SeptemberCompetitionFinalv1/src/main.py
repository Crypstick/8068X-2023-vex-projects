...
def skillsAuton():
   ...
   goStraight(100, -900) 
   wait(500, MSEC)
   rotateRight(50, 500) #90 degree turn, need to change to 360 to allow for matchload
   wait(500, MSEC)
   goStraight(100, 400) #change to reverse
   for i in range (0, 47):
     cataMotor_1.spin_for(FORWARD, 715, DEGREES, 100, PERCENT, wait=True)
   wait(200, MSEC)
   #Theory onwards
   # add another code to do 360
   # rotateLeft(50, 800)
   goStraight(80, 1500)
   wait(500, MSEC)
   rotateLeft(50, 200)
   ...
   goStraight(80, -400)
   wait(500, MSEC)
   goStraight(100, 700) #boatdrive over
   wait(500, MSEC)
   goStraight(100, -500)
   wait(500,MSEC)
   

   print("skillsAuton finish")
...
comp = Competition(driver_control, part1)